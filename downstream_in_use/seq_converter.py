...
def aa_convert_3_1(seq):
    ...
    # convert Seq object/string to 1 letter symbols from 3 (assumes no spaces)
    aa_1_seq = seq1(seq)
...
def nt_to_aa(seq):
    ...
    '''convert nucleotide sequences e.g. from genbank to aa sequences'''
...
# NOTE wrap in function, need to test
...
aa_3_characters = ['Cys', 'Asp', 'Ser', 'Gln', 'Lys', 'Ile', 'Pro', 'Thr',
