...
# sequence extracted from paper needs to be labelled as light or heavy chain 
# read into variables from FASTA file? e.g. >LIGHT_CHAIN ABCDEFGH >HEAVY_CHAIN GFHEBDCA
